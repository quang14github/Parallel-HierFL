...
# Calculate the percent difference between the global_f1 of SAC and FedAvg and Flower
avg_global_f1_SAC = sum(global_f1_SAC) / len(global_f1_SAC)
avg_global_f1_FedAvg = sum(global_f1_FedAvg) / len(global_f1_FedAvg)
avg_global_f1_Flower = sum(global_f1_Flower) / len(global_f1_Flower)
differece_SAC_FedAvg = avg_global_f1_FedAvg - avg_global_f1_SAC
differece_SAC_Flower = avg_global_f1_FedAvg - avg_global_f1_Flower
differece_FedAvg_Flower = avg_global_f1_SAC - avg_global_f1_Flower
print(differece_SAC_FedAvg / abs(avg_global_f1_FedAvg) * 100)
print(differece_SAC_Flower / abs(avg_global_f1_Flower) * 100)
print(differece_FedAvg_Flower / abs(avg_global_f1_Flower) * 100)
...
plt.figure()
plt.plot(global_f1_FedAvg, label="SAC")
plt.plot(global_f1_SAC, label="Fixed")
