...
for root, dirs, files in os.walk("runs"):
    if (
        ...
        with open(os.path.join(root, "training_time.txt"), "r") as f:
        ...
        report_data.append(
            {
                ...
                "Training Time to Baseline (s)": total_training_time,
            }
        )
